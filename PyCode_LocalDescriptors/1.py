...
from PyCode_BasicSegmentation.VolumeCutBrowser import VolumeCutBrowser
from PyCode_LocalDescriptors.BrowseGaborFiltBank import BrowseGaborFiltBank
from PyCode_LocalDescriptors.GaborFilters import GaborFilterBank2D
...
ROI_PATH = r'D:\Project\PythonProject\data_analysis\resources\VOIs\image\LIDC-IDRI-0001_R_1.nii.gz'
MASK_PATH = r'D:\Project\PythonProject\data_analysis\resources\CT\nodule_mask\LIDC-IDRI-0001_R_1.nii.gz'
IMAGE_PATH = r'D:\Project\PythonProject\data_analysis\resources\CT\image\LIDC-IDRI-0001.nii.gz'
...
#### Load ROI Volumes
niiROI, _ = readNifty(ROI_PATH)
niiMask, _ = readNifty(MASK_PATH)
niivol, _ = readNifty(IMAGE_PATH)
...
VolumeCutBrowser(imGab1, Cut='SAG')
BrowseGaborFiltBank(GaborBank2D_1, params)

VolumeCutBrowser(imGab2, Cut='SAG')
BrowseGaborFiltBank(GaborBank2D_2, params)
